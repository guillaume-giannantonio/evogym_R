...
const classes: Array<ClassType> = [
  {
    ...
    description:
      'Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et Sed ut perspiciatis unde omnis',
    image: image1,
  },
  {
    name: 'Yoga Classes',
        ...
        >
          <div className='md:w-3/5'>
            ...
            <p className='py-5'>
              ...
              quae ab illo inventore veritatis et Sed ut perspiciatis unde omnis
